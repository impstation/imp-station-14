...
namespace Content.Shared._Impstation.Prospectors.Components;

/// <summary>
/// Added to entities to tag that they are a Prospector.
/// </summary>
[RegisterComponent, NetworkedComponent]
public sealed partial class ProspectorComponent : Component
{
    #region Housekeeping

    /// <summary>
    /// The status icon prototype displayed for prospectors.
    /// </summary>
    [DataField, ViewVariables(VVAccess.ReadWrite)]
    public ProtoId<FactionIconPrototype> StatusIcon { get; set; } = "ProspectorIcon";

    [DataField] public bool IsConstruct = false;

    #endregion
    /*  Below section pertains to Cosmic Cult unique traits. Once we figure out what is unique to Prospectors, this area gets replaced.
