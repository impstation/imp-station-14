...
namespace Content.Shared._Impstation.Eeep.Components;
...
[Access(typeof(SharedBatteryDrainerEeepSystem))]
public sealed partial class BatteryDrainerEeepComponent : Component
{
    /// <summary>
