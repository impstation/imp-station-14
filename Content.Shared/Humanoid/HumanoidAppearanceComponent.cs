...
using Content.Shared.Preferences; // DeltaV used for Fugitive and Paradox Anomaly
...
public sealed partial class HumanoidAppearanceComponent : Component
{
    ...
    /// </summary>
    /// IMP EDIT BTW: HIDE YOUR FUCKING FACIAL HAIR
    [DataField]
    public HashSet<HumanoidVisualLayers> HideLayersOnEquip = [HumanoidVisualLayers.Hair, HumanoidVisualLayers.FacialHair];
