...
# imp edit; upstream desc: Heavy duty cleaner that can clean tiles the same as Space Cleaner and also decontaminate clothes. Extremely toxic when ingested.
reagent-desc-bleach = Heavy duty cleaner that can clean tiles at twice the effectiveness as Space Cleaner. Extremely toxic when ingested.
...
# imp edit; upstream desc: I wouldn't clean my mouth out with this if I were you.
reagent-desc-soap = Can clean tiles when sprayed, though not quite as effectively as space cleaner. I wouldn't clean my mouth out with this if I were you.
