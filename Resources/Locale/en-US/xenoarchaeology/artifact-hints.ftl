## The ones starting with "artifact" are deprecated. Only use  those starting with "xenoarch"
...
#IMP: Changed water tip from "Water" to be more fun & fit beverage triggers
xenoarch-trigger-tip-water = Dihydrogen monoxide
