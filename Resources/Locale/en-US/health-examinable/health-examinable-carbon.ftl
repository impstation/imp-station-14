...
health-examinable-carbon-Blunt-100 = [color=red]{ CAPITALIZE(POSS-ADJ($target)) } body is beaten, swollen and disfigured.[/color]
...
health-examinable-carbon-Piercing-200 = [color=crimson]{ CAPITALIZE(POSS-ADJ($target)) } body is shredded with holes![/color]
...
health-examinable-carbon-Heat-100 = [color=red]{ CAPITALIZE(SUBJECT($target)) } { CONJUGATE-BE($target) } burned deep enough to expose bone.[/color]
...
health-examinable-carbon-Cold-15 = [color=lightblue]{ CAPITALIZE(POSS-ADJ($target)) } fingertips are flushed and cold to the touch.[/color]
