...
petting-success-decapoid-silicon = You pet {THE($target)} on {POSS-ADJ($target)} empirically-included head.
...
petting-failure-decapoid-silicon = You reach out to pet {THE($target)}, but {POSS-ADJ($target)} empirically-included ambitions make you reconsider.
