...
traitor-gorlex-roundend = [color=red]Gorlex Marauder[/color]
...
traitor-self-roundend = [color=red]liberator from S.E.L.F.[/color]

traitor-interdyne-intro = You are an Interdyne agent.
...
traitor-interdyne-roundend = [color=#ff13f0]agent from Interdyne[/color]
...
traitor-absltn-roundend = [color=#ff0066]STAR Beneficiary from ABSLTN Corp.[/color]
...
traitor-blackpyre-roundend = [color=#eb5d0c]Undertaker from Blackpyre Funerary Corp.[/color]
...
traitor-dahir-roundend = [color=#0000cd]engineer from Dahir Insaat[/color]
...
traitor-forenserth-roundend = [color=#c8a2c8]liaison from Forenserth Corporation[/color]
...
traitor-hyuspi-roundend = [color=#000080]employee from Hyuspi[/color]
...
traitor-muscleco-roundend = [color=red]drone from Martian Labor Printing LLC[/color]
...
traitor-prospero-roundend = [color=#e35336]Smith from Prospero Corporation[/color]
...
traitor-decapoidempire-roundend = [color=#0084e8]loyalist from the Decapoid Empire[/color]
...
traitor-blackmailers-roundend = [color=#a49a87]target of blackmail[/color]
...
traitor-roubyco-roundend = [color=#fc8eac]Free Associate from ROUBY Corporation[/color]
...
traitor-centralcommand-roundend = [color=#007a9b]disposable intern from Central Command[/color]
...
traitor-honkco-roundend = [color=#ffa6c9]Prankster from Honk Co.[/color]
...
traitor-hungover-roundend = [color=brown]incredibly hungover mess[/color]
...
traitor-bigcheese-roundend = [color=#ffce1b]Mouseketeer from Big Cheese Rodent Resources[/color]
...
traitor-gildedhammer-roundend = [color=#702963]Cubor from The Gildedhammer Clan[/color]
...
traitor-blackdyrt-roundend = [color=#d70031]Assassin from the Distant Empire of Blackdyrt[/color]
...
traitor-biscuitsinc-roundend = [color=#e5aa70]hunter from Biscuits Incorporated[/color]
...
traitor-mlijeko-roundend = [color=#fefcff]Dairy Comissioner from Mlijeko Enterprises[/color]
...
traitor-theonesbehinditall-roundend = [color=#f2f0ef]puppet of The Ones Behind It All[/color]
...
traitor-thefuture-roundend = [color=#ac86ea]time traveler from The Future[/color]
...
traitor-leagueofimmorality-roundend = [color=#6e0000]Villain from League of Immorality[/color]
...
traitor-belmarktransport-roundend = [color=red]Navigator from Belmark Transportations[/color]
...
traitor-diremind-roundend = [color=#ac86ea]Psychic from DireMind[/color]
...
traitor-palehorse-roundend = [color=#d3d3d3]Handler from Pale Horse Pet Co.[/color]
...
traitor-interstellercovertagents-roundend = [color=#990000]Unionist from the Interstellar Covert Agents Association[/color]
...
traitor-concernedparents-roundend = [color=#e0d8bf]paid volunteer from the Concerned Parents Coalition[/color]
...
traitor-scoutsofnevercommander-roundend = [color=orange]supplicant of the Never Commander[/color]
...
traitor-pghfmhggmbh-roundend = [color=#ff1400]Snack Apostle from Pepsi-Goya-Haribo-Frito-Meiji-Hormel Galaktisch Gesellschaft mit beschrankter Haftung[/color]
