...
knowledge-path-ash-s3-desc =
    ...
    Grants you Blazing Dash, a spell that lets you move extremely quickly for a short time. Be sure to bring a firesuit (or Eldritch Armor, from the side knowledge tab) to protect yourself from the heat.
