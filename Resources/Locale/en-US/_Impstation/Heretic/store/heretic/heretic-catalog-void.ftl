...
knowledge-path-void-s2-desc =
    Your Mansus Grasp will temporarily mute and chill its target.
    ---

    I saw the cold watcher who observes me. The chill mounts within me.
    It is quiet. It will observe all ends.
...
knowledge-path-void-s3-desc =
    ...
    Motionless and shadowed, a depiction of a nobleman stood before me.
...
knowledge-path-void-s4-desc =
    ...
    Silence is a stillness in the air. Cold, a stillness of atoms. Death, a stillness of the soul.
...
knowledge-path-void-s5-desc =
    ...
    freezing the ground and anyone within.
    This spell requires a Focus to cast.
    ---

    It is the patron of stillness. The man in black, cloaked in silence and scythe, that some cultures called the grim reaper.

knowledge-path-void-s6-name = Void Phase
knowledge-path-void-s6-desc =
    Grants you Void Phase, a long range teleport spell.
    Additionally stuns heathens around your original location and target destination.
    This spell requires a Focus to cast.
    ---

    The entity calls itself the Aristocrat. It does not speak, for any momvement is a betrayal of itself.
    It disappears, and I am left in the blizzard.

knowledge-path-void-s7-name = Seeking Blade
knowledge-path-void-s7-desc =
    Your Void Blade chills its target on hit.
    Additionally, when a target is marked, you can activate a Void Blade in your hand to teleport next to them, without breaking the blade.
    ---
...
knowledge-path-void-s8-desc =
    ...
    The Aristocrat reveals itself to me again. It tells me I am late. Their pull is immense, I cannot turn back.
...
knowledge-path-void-s9-desc =
    ...
    When completed, grants you the Aristocrat's Blessing. Walls around you will be turned into snow and the air will constantly be frozen. Those nearby will be silenced and frozen even quicker.
    Along with this, you are able to walk through things like glass and railings, and lasers cannot hit you.
