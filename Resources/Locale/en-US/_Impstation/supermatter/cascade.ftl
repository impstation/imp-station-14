resonance-cascade-announcement-begin =
    A Type-C resonance shift event has occurred in your sector.
    Scans indicate local oscillation flux affecting spatial and gravitational substructure.
    Multiple resonance hotspots have formed.
    Please standby.
resonance-cascade-announcement-middle =
    Reports indicate formation of crystalline seeds following resonance shift event.
