...
spellbook-frost-desc = Fire a deadly spear of ice. Requires a wizard hat and robe to cast.
...
spellbook-wand-heal-description = Who needs medbay!
...
spellbook-stamp-name = Wizard stamp
...
spellbook-event-summon-gifts-description = Are you naughty or nice?

spellbook-event-summon-magic-soap-name = Summon Soap
spellbook-event-summon-soap-description = Good for big messes.
