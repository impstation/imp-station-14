...
seclink-citationator-name = Citationator
seclink-citationator-desc = A compressed air launcher specially designed to issue tickets and warnings with precision
seclink-shield-name = Compact Shield
seclink-shield-desc = A simple metal shield that collapses for storage. It may not be very durable but it's easy to fix.
seclink-nvgoggles-name = Surplus Night Vision Goggles
seclink-nvgoggles-desc = Night vision goggles you would expect to see in a museum. They still work, but the image quality isn't great.
