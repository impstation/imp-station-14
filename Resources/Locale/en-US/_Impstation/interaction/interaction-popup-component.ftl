...
petting-success-goliath = You pet {THE($target)} on {POSS-ADJ($target)} tentacle-covered head.
...
petting-failure-goliath = You try to pet {THE($target)}, but a tentacle wraps around your hand to stop you.
