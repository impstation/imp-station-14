...
obvious-x-pin-veteran = a [color=#FCC200]veteran[/color] [color=#560590]mark[/color], identifying as a [color=#efefef]mentor[/color]. [color=#560590][italic]Please ask { OBJECT($user) } any questions![/italic][/color]
