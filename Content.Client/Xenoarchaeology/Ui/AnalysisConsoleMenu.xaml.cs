...
public sealed partial class AnalysisConsoleMenu : FancyWindow
{
    ...
    private readonly SharedAdvancedNodeScannerSystem _advancedNodeScannerSystem; //imp: advanced node scanner system
    ...
    public AnalysisConsoleMenu()
    {
        ...
        _advancedNodeScannerSystem = _ent.System<SharedAdvancedNodeScannerSystem>(); //imp: advanced node scanner system
    ...
    public void Update(Entity<AnalysisConsoleComponent> ent)
    {
        ...
        else if (arti is {Comp.Natural: false } && arti.Value.Comp.AdvancedNodeScanner is not null)
        {
            // Minimise TryComp calls in update(): save component
            ...
            if (_advancedNodeScannerSystem.GetCurrentUnlockSession(arti.Value, _advancedNodeScanner) is
                { } unlockSession)
                _unlockEndTime = unlockSession.EndTime;
        }
        // imp edit end
