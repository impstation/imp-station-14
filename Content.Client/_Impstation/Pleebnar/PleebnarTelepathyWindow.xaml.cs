...
public sealed partial class PleebnarTelepathyWindow : FancyWindow
{
    ...
    public PleebnarTelepathyWindow()
    {
        ...
        RandomVisionButton.OnPressed += OnRandomPressed;
    ...
    private void OnRandomPressed( BaseButton.ButtonEventArgs args)
    {
        var randVis=_random.Pick(_visions);
        OnVisionSelect?.Invoke(randVis.ID);
    }
}
