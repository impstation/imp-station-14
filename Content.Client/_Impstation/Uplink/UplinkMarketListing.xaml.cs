...
public sealed partial class UplinkMarketListing : Control
{
    ...
    public UplinkMarketListing(ListingDataWithCostModifiers data, string price, string discount, bool hasBalance, Texture? texture = null, string? extra = null) // imp add extra
    {
