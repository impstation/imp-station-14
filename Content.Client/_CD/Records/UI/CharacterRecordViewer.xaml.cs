...
public sealed partial class CharacterRecordViewer : FancyWindow
{
    ...
    //imp edit - needed for the job icons
    ...
    public CharacterRecordViewer()
    {
        ...
        IoCManager.InjectDependencies(this); //imp edit - needed for job icons

        _spriteSystem = _entitySystem.GetEntitySystem<SpriteSystem>(); //imp edit - needed for job icons
        ...
        StatusOptionButton.OnItemSelected += args =>
        {
            ...
            if (status == SecurityStatus.Wanted || status == SecurityStatus.Suspected || status == SecurityStatus.Hostile) // imp add hostile
    ...
    public void UpdateState(CharacterRecordConsoleState state)
    {
        ...
        RecordContainerJobIcon.Texture =
            _spriteSystem.Frame0(_prototypeManager.Index(record.JobIcon).Icon); //imp edit - display the icon
        RecordContainerGender.Text = Loc.GetString("records-computer-pronouns", ("gender", record.Gender.ToString().ToLowerInvariant()));
        ...
        RecordContainerYear.Text = cr.Year + " ";
