...
/// <summary>
/// Dark-step teleport system.
/// Validates luminance and destination before and after the do-after.
/// </summary>
public sealed class LightLevelTeleportSystem : SharedLightLevelTeleportSystem
{
    ...
    /// <summary>
    /// Validate the chosen dark-step destination.
    /// </summary>
    ...
    /// <summary>
    /// Get valid teleport coordinates.
    /// </summary>
    ...
    /// <summary>
    /// Delete the temporary dark-step marker if it still exists.
    /// </summary>
