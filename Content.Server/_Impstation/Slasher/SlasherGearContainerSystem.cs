...
public sealed class SlasherGearContainerSystem : EntitySystem
{
    ...
    /// <summary>
    /// Type definition for OnUIOpened.
    /// </summary>
    /// <param name="container">Parameter used by this method: container.</param>
    ...
    /// <summary>
    /// Type definition for SpawnStorage.
    /// </summary>
    /// <param name="container">Parameter used by this method: container.</param>
    ...
    /// <summary>
    /// Type definition for ResolveVariantGear.
    /// </summary>
    /// <param name="component">Component instance containing state/configuration values.</param>
    ...
    /// <summary>
    /// Type definition for TagAppearanceItem.
    /// </summary>
    /// <param name="entity">Parameter used by this method: entity.</param>
    /// <param name="ownerMind">Mind entity UID associated with the actor.</param>
    ...
    /// <summary>
    /// Type definition for PlaceSpawnedItem.
    /// </summary>
    /// <param name="entity">Parameter used by this method: entity.</param>
    /// <param name="containerUid">Parameter used by this method: containerUid.</param>
    /// <param name="spawnedStorage">Parameter used by this method: spawnedStorage.</param>
    ...
    /// <summary>
    /// Type definition for FinalizeStorage.
    /// </summary>
    ...
    /// <summary>
    /// Type definition for SetSelectedVariant.
    /// </summary>
    /// <param name="actor">Entity performing this action.</param>
    /// <param name="variantGearId">Parameter used by this method: variantGearId.</param>
    ...
    /// <summary>
    /// Type definition for OnChangeSet.
    /// </summary>
    /// <param name="container">Parameter used by this method: container.</param>
    /// <param name="args">Event arguments for this callback.</param>
