...
public sealed partial class CosmicMalignRiftComponent : Component
{
    ...
    [DataField] public TimeSpan BibleTime = TimeSpan.FromSeconds(75); //todo 75
    [DataField] public TimeSpan ChaplainTime = TimeSpan.FromSeconds(45); //todo 45
    [DataField] public TimeSpan AbsorbTime = TimeSpan.FromSeconds(35); //todo 35
}
