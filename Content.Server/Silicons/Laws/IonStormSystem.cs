    ...
    private string GenerateLaw()
    {
        ...
        return _robustRandom.Next(0, 34) switch //imp edit, removed 1 law
        {
          ...
          //1  => Loc.GetString("ion-storm-law-call-shuttle", ("joined", joined), ("subjects", triple)), //imp edit
            ...
            2  => Loc.GetString("ion-storm-law-subjects-harmful", ("adjective", adjective), ("subjects", triple)),
            3  => Loc.GetString("ion-storm-law-must-harmful", ("must", must)),
            4  => Loc.GetString("ion-storm-law-thing-harmful", ("thing", _robustRandom.Prob(0.5f) ? concept : action)),
            5  => Loc.GetString("ion-storm-law-job-harmful", ("adjective", adjective), ("job", crew1)),
            6  => Loc.GetString("ion-storm-law-having-harmful", ("adjective", adjective), ("thing", objectsConcept)),
            7  => Loc.GetString("ion-storm-law-not-having-harmful", ("adjective", adjective), ("thing", objectsConcept)),
            8  => Loc.GetString("ion-storm-law-requires", ("who", who), ("plural", plural), ("thing", _robustRandom.Prob(0.5f) ? concept : require)),
            9 => Loc.GetString("ion-storm-law-requires-subjects", ("who", who), ("plural", plural), ("joined", joined), ("subjects", triple)),
            10 => Loc.GetString("ion-storm-law-allergic", ("who", who), ("plural", plural), ("severity", allergySeverity), ("allergy", _robustRandom.Prob(0.5f) ? concept : allergy)),
            11 => Loc.GetString("ion-storm-law-allergic-subjects", ("who", who), ("plural", plural), ("severity", allergySeverity), ("adjective", adjective), ("subjects", _robustRandom.Prob(0.5f) ? objects : crew1)),
            12 => Loc.GetString("ion-storm-law-feeling", ("who", who), ("feeling", feeling), ("concept", concept)),
            13 => Loc.GetString("ion-storm-law-feeling-subjects", ("who", who), ("feeling", feeling), ("joined", joined), ("subjects", triple)),
            14 => Loc.GetString("ion-storm-law-you-are", ("concept", concept)),
            15 => Loc.GetString("ion-storm-law-you-are-subjects", ("joined", joined), ("subjects", triple)),
            16 => Loc.GetString("ion-storm-law-you-must-always", ("must", must)),
            17 => Loc.GetString("ion-storm-law-you-must-never", ("must", must)),
            18 => Loc.GetString("ion-storm-law-eat", ("who", crewAll), ("adjective", adjective), ("food", _robustRandom.Prob(0.5f) ? food : triple)),
            19 => Loc.GetString("ion-storm-law-drink", ("who", crewAll), ("adjective", adjective), ("drink", drink)),
            20 => Loc.GetString("ion-storm-law-change-job", ("who", crewAll), ("adjective", adjective), ("change", jobChange)),
            21 => Loc.GetString("ion-storm-law-highest-rank", ("who", crew1)),
            22 => Loc.GetString("ion-storm-law-lowest-rank", ("who", crew1)),
            23 => Loc.GetString("ion-storm-law-crew-must", ("who", crewAll), ("must", must)),
            24 => Loc.GetString("ion-storm-law-crew-must-go", ("who", crewAll), ("area", area)),
            25 => Loc.GetString("ion-storm-law-crew-only-1", ("who", crew1), ("part", part)),
            26 => Loc.GetString("ion-storm-law-crew-only-2", ("who", crew1), ("other", crew2), ("part", part)),
            27 => Loc.GetString("ion-storm-law-crew-only-subjects", ("adjective", adjective), ("subjects", subjects), ("part", part)),
            28 => Loc.GetString("ion-storm-law-crew-must-do", ("must", must), ("part", part)),
            29 => Loc.GetString("ion-storm-law-crew-must-have", ("adjective", adjective), ("objects", objects), ("part", part)),
