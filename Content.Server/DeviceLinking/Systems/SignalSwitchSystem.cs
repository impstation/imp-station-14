...
public sealed class SignalSwitchSystem : EntitySystem
{
    ...
    private void OnActivated(EntityUid uid, SignalSwitchComponent comp, ActivateInWorldEvent args)
    {
        ...
        var ev = new SwitchPressedEvent(); //imp
        RaiseLocalEvent(uid, ref ev); //imp
...
[ByRefEvent]
/// <summary>
/// IMP. Event to inform any other systems that may want to know that the signal switch was pressed
/// </summary>
