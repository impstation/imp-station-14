...
namespace Content.Server.Nutrition.EntitySystems
{
    public sealed partial class SmokingSystem
    {
        ...
        private bool VapePuff(Entity<VapePenComponent> entity, EntityUid user, EntityUid target, bool canReach)
        {
            ...
            if (!TryGetCartFromSlot(entity.Owner, entity.Comp, out var cart))
            {
                _popupSystem.PopupEntity(
                    Loc.GetString("vape-component-vape-cart-slot-empty"), target,
                    user);
                return false;
            }
            ...
            {
                _popupSystem.PopupEntity(
                    Loc.GetString("vape-component-vape-cart-solution-empty"), target,
                    user);
                return false;
            }
            ...
            {
                _popupSystem.PopupEntity(Loc.GetString("vape-component-vape-incompatible"), target, user);
                return false;
            }
            ...
            if (entity.Comp.ExplodeOnUse
                || HasComp<EmaggedComponent>(entity.Owner)
                || invalidQuantity)
            {
                exploded = true;
        ...
        private void OnVapeDoAfter(Entity<VapePenComponent> entity, ref VapeDoAfterEvent args)
        {
            ...
            {
                _popupSystem.PopupEntity(
                    Loc.GetString("vape-component-vape-cart-slot-empty"), args.Args.Target.Value,
                    args.Args.User);
                return;
            }
            ...
            if (args.Forced)
            {
                ...
                _popupSystem.PopupEntity(
                    Loc.GetString("vape-component-vape-success-forced", ("user", userName), ("flavors", flavors)), args.Args.Target.Value,
            ...
            {
                _popupSystem.PopupEntity(
                    Loc.GetString("vape-component-vape-success", ("flavors", flavors)), args.Args.Target.Value,
                    args.Args.Target.Value);
            }
