...
public sealed partial class GoobChangelingSystem : EntitySystem
{
    ...
    public void OnAugmentedEyesight(EntityUid uid, GoobChangelingComponent comp, ref ActionAugmentedEyesightEvent args)
    {
        ...
        var flashImmune = new FlashImmunityComponent
        {
            Enabled = true,
            ShowInExamine = false //#IMP Don't give away that we're a changeling by showing "It provides protection from bright flashes"
        };
        AddComp(uid, flashImmune);
